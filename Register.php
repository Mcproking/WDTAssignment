...
<body>
    <div id="wrapper">
        ...
        <div id="register" align="center">
            ...
            <form action="loginEmail.html" method="post" id="Form">
                <div id="Username">
                    <label for="username">Username* </label><br>
                    <input type="text" name="txtUsername" id="username" autofocus required>
                </div>

                <div id="Password">
                    <label for="password">Password* </label><br>
                    <input type="password" name="txtPassword" id="password" pattern="(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*?[~`!@#$%^&*()_-+={}[]|\:;,.?/]).{8,}" title="Password must contain at least one uppercase letter, one lowercase letter, one digit, one special character, and at least 8 characters in length" required>
                </div>
                ...
                <div id="Phone_No">
                    ...
                    <input type="tel" name="Phone" id="phone" placeholder="012-345-6789" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required>
                </div>   
                ...
                <div id="Address">
                    <label for="address">Address (Optional)<br><textarea name="txtAddress" id="address" cols="50" rows="3" autocomplete="off"></textarea></label>
                </div>     
